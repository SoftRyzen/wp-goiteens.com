...
class payment
{
    ...
    private function setHeaderDataArray(array $payment_array)
    {
        ...
        $this->w4p_curl_header_data['serviceUrl'] = 'https://payment-w4p-if.goiteens.ua/service/?merch_id=' . $payment_array['merchant_id'] . '&invoice_id=' . $payment_array['invoice_id'] . '&requesttype=payment&w4p_pass=klasjdaklsjdaxvcvhu9h3423';
        ...
        $this->w4p_payment_invoice_id = strval($payment_array['invoice_id']);
    }
