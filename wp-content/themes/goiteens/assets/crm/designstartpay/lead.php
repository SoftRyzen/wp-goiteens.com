...
$additionalParameters = array(  // правити для кожного окремого ленда!
    ...
    "returnURL" => "https://goiteens.com/wp-content/themes/goiteens/assets/crm/designstartpay/return_url.php",        // перевірка статусу оплати
    "productPrice" => 199,                                                     // ціна продукту
