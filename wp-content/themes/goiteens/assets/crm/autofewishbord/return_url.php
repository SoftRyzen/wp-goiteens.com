...
$credentialsURL = array(
    "sucessURL" => "https://goiteens.com/course/fe-start/fe-star-thx/",        // перенаправлення після успішної оплати
    "errorURL" => "https://goiteens.com/course/fe-start/fe-start-thx/",        // перенаправлення після помилки оплати
);
