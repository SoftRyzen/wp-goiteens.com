...
$credentialsURL = array(
    "sucessURL" => site_url() . "/course/python-start/python-start-thx-test/",        // перенаправлення після успішної оплати
    "errorURL" => site_url() . "/course/python-start/python-start-thx-test/",        // перенаправлення після помилки оплати
);
