  ...
  <div class="container">
    <div class="footer__wrapper">
      ...
      <div class="wrapper__logo">
        <a href="/" class="link footer__logo" target="_blank" rel="nofollow noopener noreferrer">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/roblox/logo-black.svg" alt="<?php echo get_field('logo_alt_aria', 'option'); ?>" width="143" height="37" />
        </a>
      </div>
...
<?php endif; ?>
        ...
        <div class="payment">
          ...
          <a class="link payment__contract" href="<?php the_field('policy_link', 'option'); ?>" aria-label="goiteens programs" target="_blank"
