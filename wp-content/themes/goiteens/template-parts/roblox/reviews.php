  ...
  <div class="container">
    ...
    <div class="reviews__list reviews-slider-js">
      ...
      <?php    
        ...
        <picture>
            <source srcset="
               <?php echo get_template_directory_uri(); ?>/assets/images/roblox/reviews/<?php echo $item->parents_img_id ; ?>.webp    1x,
               <?php echo get_template_directory_uri(); ?>/assets/images/roblox/reviews/<?php echo $item->parents_img_id ; ?>@2x.webp 2x
            " media="(min-width: 280px)" type="image/webp" />

            <source srcset=" <?php echo get_template_directory_uri(); ?>/assets/images/roblox/reviews/<?php echo $item->parents_img_id ; ?>@2x.jpg 2x" media="(min-width: 280px)"
              type="image/jpeg" />
            <img class="reviews__item-img" src=" <?php echo get_template_directory_uri(); ?>/assets/images/roblox/reviews/<?php echo $item->parents_img_id ; ?>.jpg"
