    ...
    <div class="container">
        ...
        <ul class="int-math_year-list">
            <li class="int-math_year-item">
                <h4>1 рік</h4>
                <p>Математичні скіли та візуальне програмування</p>
            </li>
            <li class="int-math_year-item">
                <h4>2 рік</h4>
                <p>Вивчення коду та побудова логічних ланцюжків</p>
            </li>
        </ul>
        </div>
        ...
        srcset="<?= get_template_directory_uri() ?>/assets/images/new-minecraft/tree-2x-mob.png 2x"/>
            ...
            <div>
            <h3 class="subtitle">Чим діти займаються на уроках?</h3>
            ...
            <p>Працюючи на платформі Майнкрафті, дитина сприймає Математику як «живий» та корисний предмет!</p>
            </div>
        </div>
        <div class="info-box">
            <h3>Дитина в захваті і батьки задоволені</h3>
            <p>«Займаємося на курсі Майнкрафт 6 місяців і дуже задоволені. Організовано все на дуже високому рівні, все продумано. Викладачі відмінні… Велике дякую. Всім рекомендуємо і бажаємо успіхів.»</p>
            <p class="name">Владислав Арут</p>
        </div>
