<section class="section advantages">
    <div class="container">
        <div class="advantages__descr">
            <h2 class="section-title"><?php the_field('all_advantages_title'); ?></h2>
            <p class="advantages__label"><?php the_field('all_advantages_label'); ?></p>
        </div>
		<?php $advantagesList= get_field('all_advantages_list');
	  if($advantagesList): ?>
