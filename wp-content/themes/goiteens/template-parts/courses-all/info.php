  ...
  <div class="info-awards">
    <div class="container">
        ...
        <li class="grid__item info-awards-item">
          ...
          <picture>
            <source srcset="
                <?php echo get_template_directory_uri(); ?>/assets/images/courses-all/info/info-<?php echo $item->award_numb_id; ?>.webp    1x,
                <?php echo get_template_directory_uri(); ?>/assets/images/courses-all/info/info-<?php echo $item->award_numb_id; ?>@2x.webp 2x
              " type="image/webp" />
            <source srcset="./assets/images/courses-all/info/info-<?php echo $item->award_numb_id; ?>@2x.png 2x" type="image/png" />
            <img class="info-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/courses-all/info/info-<?php echo $item->award_numb_id; ?>.png"
