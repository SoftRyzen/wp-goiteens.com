<div class="backdrop is-hidden" data-modal>
    <div class="modal-outer">
        ...
        <img class="logo header__img" src="<?php echo get_template_directory_uri(); ?>/assets/images/header/logo.svg"
            alt="<?php the_field('logo_alt', 'option'); ?>" width="143" height="37" />
        ...
        <form class="modal-form" id="register_form" novalidate data-form>
            <h2 class="modal-title"><?php the_field('hero_title'); ?> <?php the_field('modal_title_year'); ?></h2>
            <p class="modal-subtitle"><?php the_field('modal_subtitle'); ?></p>
            <div class="modal-group">
                <label class="modal-label" for="register_form_input_name">
            ...
            <div class="modal-group">
                <label class="modal-label" for="register_form_input_tel">
            ...
            <div class="modal-group">
                <label class="modal-label" for="register_form_input_email">
            ...
            <?php $categoriesList = get_field('categories_select');
      if ($categoriesList) : ?>
            <div class="modal-group">
                <label class="modal-label" for="register_form_select">
                    <?php the_field('categories_select_title'); ?> <span class="modal-label-required"> * </span></label>
                <select class="modal-input modal-select" id="register_form_select" name="selected_course"
                    data-form-select>
