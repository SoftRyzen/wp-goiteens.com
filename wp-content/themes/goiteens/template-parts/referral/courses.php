<section class="section courses" id="all_courses">
    <div class="container">
        <h2 class="section-title"><?php the_field('referral_courses_title'); ?></h2>
<?php $coursesList = get_field('referral_courses_items');
		if( $coursesList ): ?>
		...
		$btnMoreText= get_field('referral_details_btn');
		$btnMoreData= "data-show-more";
		$btnData= "data-modal-open"
		?>
	 <?php get_template_part( 'template-parts/referral/components/btn', null, ['btnType' => $btnType, 'btnClass' => $btnMoreClass, "btnData" => $btnMoreData, "btnText" => $btnMoreText ]  ); ?> 
                ...
                <div class="courses__about is-hidden" data-more-text>
                                ...
                                <li class="courses__program-item">
                                    ...
                                    <ul
                                        ...
                                        <li class="courses__icon-item">
                                            <picture>
                                                <source
                                                    srcset="<?php echo get_template_directory_uri(); ?>/assets/images/referral/courses/icon/<?php echo "{$icon['text']}" ; ?>.webp 1x, <?php echo get_template_directory_uri(); ?>/assets/images/referral/courses/icon/<?php echo "{$icon['text']}" ; ?>@2x.webp 2x"
                                                    type="image/webp" />

                                                <source
                                                    srcset="<?php echo get_template_directory_uri(); ?>/assets/images/referral/courses/icon/<?php echo "{$icon['text']}" ; ?>.png 1x, <?php echo get_template_directory_uri(); ?>/assets/images/referral/courses/icon/<?php echo "{$icon['text']}" ; ?>@2x.png 2x"
                                                    type="image/png" />

                                                <img class="courses__icon-img"
                                                    src="<?php echo get_template_directory_uri(); ?>/assets/images/referral/courses/icon/<?php echo "{$icon['text']}" ; ?>.png"
                    ...
                    <button class="courses__up-btn" type="button" data-show-less>
                        <svg class="courses__up-icon" width="32" height="32">
                            <use href="<?php echo get_template_directory_uri(); ?>/assets/images/referral/sprite.svg#icon-arrow-up"></use>
                        </svg>
                    </button>
                </div>
            </li>
